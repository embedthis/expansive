...
#
ifeq ($(ME_COM_EST),1)
    DEPS_35 += $(BUILD)/bin/libest.a
endif
DEPS_35 += $(BUILD)/obj/est.o

$(BUILD)/bin/libmpr-estssl.a: $(DEPS_35)
...
ifeq ($(ME_COM_SSL),1)
ifeq ($(ME_COM_EST),1)
    DEPS_36 += $(BUILD)/bin/libmpr-estssl.a
endif
endif
...
$(BUILD)/bin/libmpr.dylib: $(DEPS_36)
	...
	$(CC) -dynamiclib -o $(BUILD)/bin/libmpr.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libmpr.dylib -compatibility_version 0.5 -current_version 0.5 "$(BUILD)/obj/mprLib.o" $(LIBPATHS_36) $(LIBS_36) $(LIBS_36) $(LIBS) 
...
$(BUILD)/bin/libhttp.dylib: $(DEPS_38)
	...
	$(CC) -dynamiclib -o $(BUILD)/bin/libhttp.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libhttp.dylib -compatibility_version 0.5 -current_version 0.5 "$(BUILD)/obj/httpLib.o" $(LIBPATHS_38) $(LIBS_38) $(LIBS_38) $(LIBS) 
endif
...
$(BUILD)/bin/libejs.dylib: $(DEPS_40)
	...
	$(CC) -dynamiclib -o $(BUILD)/bin/libejs.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libejs.dylib -compatibility_version 0.5 -current_version 0.5 "$(BUILD)/obj/ejsLib.o" $(LIBPATHS_40) $(LIBS_40) $(LIBS_40) $(LIBS) 
endif
...
$(BUILD)/bin/ejsc: $(DEPS_41)
	@echo '      [Link] $(BUILD)/bin/ejsc'
	$(CC) -o $(BUILD)/bin/ejsc -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/ejsc.o" $(LIBPATHS_41) $(LIBS_41) $(LIBS_41) $(LIBS) 
endif
...
#   expansive.mod
#
DEPS_44 += src/expansive.es
DEPS_44 += src/ExpParser.es
DEPS_44 += paks/ejs-version/Version.es
ifeq ($(ME_COM_EJS),1)
    DEPS_44 += $(BUILD)/bin/ejs.mod
endif

$(BUILD)/bin/expansive.mod: $(DEPS_44)
...
ifeq ($(ME_COM_EJS),1)
    DEPS_45 += $(BUILD)/bin/libejs.dylib
endif
DEPS_45 += $(BUILD)/bin/expansive.mod
DEPS_45 += $(BUILD)/obj/expansive.o
DEPS_45 += $(BUILD)/obj/expParser.o
...
$(BUILD)/bin/expansive: $(DEPS_45)
	@echo '      [Link] $(BUILD)/bin/expansive'
	$(CC) -o $(BUILD)/bin/expansive -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/expansive.o" "$(BUILD)/obj/expParser.o" $(LIBPATHS_45) $(LIBS_45) $(LIBS_45) $(LIBS) 
...
$(BUILD)/bin/http: $(DEPS_46)
	...
	$(CC) -o $(BUILD)/bin/http -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/http.o" $(LIBPATHS_46) $(LIBS_46) $(LIBS_46) $(LIBS) 
endif
