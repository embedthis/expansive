...
$(BUILD)/obj/expParser.o: \
	...
	$(CC) -c -o $(BUILD)/obj/expParser.o $(LDFLAGS) $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 $(IFLAGS) src/expParser.c
...
$(BUILD)/obj/expansive.o: \
	...
	$(CC) -c -o $(BUILD)/obj/expansive.o $(LDFLAGS) $(CFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 $(IFLAGS) src/expansive.c
...
$(BUILD)/bin/libmpr.so: $(DEPS_35)
	...
	$(CC) -shared -o $(BUILD)/bin/libmpr.so $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/mprLib.o" -lmpr-mbedtls $(LIBPATHS_35) $(LIBS_35) $(LIBS_35) $(LIBS) 
...
$(BUILD)/bin/libhttp.so: $(DEPS_37)
	...
	$(CC) -shared -o $(BUILD)/bin/libhttp.so $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/httpLib.o" $(LIBPATHS_37) $(LIBS_37) $(LIBS_37) $(LIBS) -lmpr-mbedtls 
endif
...
$(BUILD)/bin/libejs.so: $(DEPS_39)
	...
	$(CC) -shared -o $(BUILD)/bin/libejs.so $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/ejsLib.o" $(LIBPATHS_39) $(LIBS_39) $(LIBS_39) $(LIBS) -lmpr-mbedtls 
endif
...
$(BUILD)/bin/expansive-ejsc: $(DEPS_40)
	...
	$(CC) -o $(BUILD)/bin/expansive-ejsc $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/ejsc.o" $(LIBPATHS_40) $(LIBS_40) $(LIBS_40) $(LIBS) -lmpr-mbedtls $(LIBS) -lmpr-mbedtls 
endif
...
$(BUILD)/bin/expansive: $(DEPS_44)
	...
	$(CC) -o $(BUILD)/bin/expansive $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/expansive.o" "$(BUILD)/obj/expParser.o" $(LIBPATHS_44) $(LIBS_44) $(LIBS_44) $(LIBS) -lmpr-mbedtls $(LIBS) -lmpr-mbedtls 
